                        ...
                        <div class="flex flex-wrap mb-5">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select2-single form-control" name="district" id="district">
                                            ...
                                            <option value="{{ $val->code }}" {{ ($editing ? (($staff->district_code ==
                                                $val->code) ? 'selected' : '') : '') }}>{{ $val->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select2-single form-control" name="village" id="village">
                                            ...
                                            <option value="{{ $val->code }}" {{ ($editing ? (($staff->village_code ==
                                                $val->code) ? 'selected' : '') : '') }}>{{ $val->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2-single form-control" name="roles" id="select2Single">
                                    ...
                                    <option value="{{$role->id}}" {{ ($editing ? (($user->hasRole($role)) ? 'selected' :
                                        '') : '') }}>{{$role->name}}</option>
                                    @endforeach
                                </select>
                            </div>
