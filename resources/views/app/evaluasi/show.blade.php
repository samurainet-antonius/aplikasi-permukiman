                        ...
                        <div class="col-4">
                            <div class="card mb-3" style="height: 300px; !important">
                                <div class="row no-gutters align-items-center">
                                    <div
                                        class="col-md-12 text-white {{$color}} py-4 rounded-top align-items-right text-center">
                                        <div class="row">
                                            <div class="col">
                                                @if ($item->foto->isNotEmpty())
                                                <img src="{{ asset('public/'.$item->foto[0]->foto) }}"
                                                    class="img-thumbnail ml-4" style="max-height: 100px;" />
                                                @else
                                                <p>Tidak ada foto</p>
                                                @endif
                                            </div>
    ...
    <div class="modal fade" id="edit-{{$value->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST"
                    action="{{ route('evaluasi.store.kriteria.edit', ['evaluasi_id' => $evaluasi->id]) }}" has-files
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="row">
                                <input type="text" class="ml-4 col-8 form-control" value="{{$item->skor}}"
                                    placeholder="masukan skor"
                                    name="jawaban[{{$value->kriteria_id}}][{{$item->subkriteria_id}}]" required>
                                <h6 class="col-2 mt-2">{{ $item->subkriteria->satuan }}</h6>
                            </div>
                            <br />
                            <div class="row">
                                <input type="text" class="ml-4 col-8 form-control" value="{{$item->persen}}"
                                    placeholder="masukan skor"
                                    name="persen[{{$value->kriteria_id}}][{{$item->subkriteria_id}}]" required>
                        ...
                        <div class="form-group mt-5">
                            ...
                            <input type="file" class="form-control mt-2" id="file" name="file[]" accept="image/*"
                                multiple>
                            ...
                            <div class="border border-danger text-danger rounded p-2 mt-2 py-3 col-6">
                                ...
                                <a href="{{ route('evaluasi.delete.foto', ['evaluasi_id' => $evaluasi->id, 'id' => $val->id ]) }}"
                            ...
                            <div class="modal fade" id="modal-{{$val->id}}" tabindex="-1"
